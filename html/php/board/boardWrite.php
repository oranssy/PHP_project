                    ...
                    <form action="boardWriteSave.php" name="boardWrite" method="post">
                        <fieldset>
                            ...
                            <div>
                                ...
                                <input type="text" name="boardTitle" id="boardTitle" placeholder="게시글 제목을 입력해주세요.">
                            </div>
                            <div>
                                <label for="boardContents">내용</label>
                                <textarea name="boardContents" id="boardContents" rows="20" placeholder="게시글 본문을 입력해주세요."></textarea>
                            </div>
